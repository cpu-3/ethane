...
HD_PWD='/home/tansei/pro/vivado/ethane/ethane.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log core_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source core_wrapper.tcl
