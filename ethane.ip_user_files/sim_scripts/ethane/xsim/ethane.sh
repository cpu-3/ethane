...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xil_defaultlib -L blk_mem_gen_v8_4_1 -L xlconstant_v1_1_3 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot ethane xil_defaultlib.ethane xil_defaultlib.glbl -log elaborate.log
}
